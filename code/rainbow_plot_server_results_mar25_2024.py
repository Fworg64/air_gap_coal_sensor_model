...
axs1.set_ylim(0.0,1)
plt.xticks(xtickvals, labels=filter_ticks_list, rotation=45)
...
fig1.suptitle(f"$R^2$ Distributions\nwith Median, Quartile, and Min/Max values", y=0.96)
...
axs1.legend(r2_legend_artists, r2_legend_labels, loc="lower left")
...
fig2.suptitle(f"MAE Distributions with\nMedian, Quartile, and Min/Max values", y=0.96)
...
axs2.legend(legend_artists, legend_labels, loc="lower left")
